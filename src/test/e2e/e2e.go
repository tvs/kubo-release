...
var _ = ginkgo.SynchronizedBeforeSuite(func() []byte {
	...
	// Delete any namespaces except those created by the system
	if framework.TestContext.CleanStart {
		deleted, err := framework.DeleteNamespaces(c, nil,
			[]string{
...
// RunE2ETests checs configuration parameters (specified through flags) and then runs
// E2E tests using the Ginkgo runner.
// If a "report directory" is specified, one or more JUinit test reports will be
...
func RunE2ETests(t *testing.T) {
	...
	ginkgo.RunSpecsWithDefaultAndCustomReporters(t, "CFCR E2E Suite", r)
}
